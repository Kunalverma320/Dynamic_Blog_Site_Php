...
$sql = "SELECT * FROM news order by entry_date desc";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if(isset($_FILES["image_url"]) && $_FILES["image_url"]["error"] == 0) {
    ...
    $sqlnews = "INSERT INTO news (Title, comment, href, image_url, ahref, author_name, 
entry_date, ohref, photo_down_name, popular, status) 
    ...
    if ($con->query($sqlnews) === TRUE) {
        echo "<script>alert('News Add successfully');</script>";
       echo "<script type='text/javascript'> document.location = 'news.php'; </script>";
    } else {
        echo "Error: " . $sqlnews . "<br>" . $con->error;
    }
    $con->close();
}
...
<body>
    ...
    <div class="container-fluid">
        <div class="main-content d-flex flex-column">
            ...
            <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
                <!-- <h3 class="mb-sm-0 mb-1 fs-18">News Upload</h3> -->
                <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
                    ...
                    <li>
                        <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">News Upload</span>
                    </li>
                </ul>
            </div>
                        ...
                        <ul class="nav nav-tabs border-0 courses-tab justify-content-center justify-content-sm-start mb-3 mb-sm-0"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link fs-18 fw-semibold border-0 active" id="enrolled-tab"
                                    ...
                                    aria-controls="enrolled-tab-pane" aria-selected="true">News</button>
                            </li>
                                                ...
                                                <td>
                                                    <div class="dropdown action-opt">
                                                        ...
                                                        <ul
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="newsedit.php?id=<?php echo $row['id']; ?>">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom p-4">
            <h5 class="offcanvas-title fs-18 mb-0" id="offcanvasRightLabel">Add News</h5>
        ...
        <div class="offcanvas-body p-4">
            <form method="post" name="addnews" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    <label class="label">News Comment</label>
                    ...
                    <!-- <textarea class="form-control" name="comment" placeholder="News Comment" cols="30"
                        rows="5"></textarea> -->
                </div>
                <div class="form-group mb-4">
                    <label class="label">News Href</label>
                    <input type="text" name="href" class="form-control text-dark" placeholder="News Href">
                </div>
                <div class="form-group mb-4">
