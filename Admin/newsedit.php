    ...
    if(isset($_POST['editnews']))
{
    ...
    $msg=mysqli_query($con,"update news set Title='$Title',comment='$comment',href='$href',ahref='$ahref',author_name='$author_name',entry_date='$entry_date',ohref='$ohref',photo_down_name='$photo_down_name',popular='$popular',status='$status',image_url='$image_url' where id='$userid'");

if($msg)
{
    echo "<script>alert('News Post updated successfully');</script>";
...
$query=mysqli_query($con,"select * from news where id='$userid'");
...
{?>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="href" value="<?php echo isset($result['href']) ? $result['href']:'';?>"
                            class="form-control text-dark" placeholder="News Href">
                    </div>
                    <div class="form-group mb-4">
