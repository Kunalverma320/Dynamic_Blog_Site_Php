<?php
     ...
     $ret=mysqli_query($con,"select * from articles where id=$id limit 1");
    ...
    $photo_down_name=$row['photo_down_name'];
        ...
        $sql="select * from articles where id=$id_new limit 1";
            ...
            <div class="td-pb-span12 td-main-content" role="main">
                <div class="td-ss-main-content">
                        ...
                        <div id="td_social_sharing_article_top"
                            ...
                            <div class="td-post-sharing-visible">
                                <a class="td-social-sharing-button td-social-sharing-button-js td-social-network td-social-facebook"
                                    href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdemo.tagdiv.com%2Fnewspaper_photography%2Ftd-post-comparing-black-and-white-films%2F"
                                    title="Facebook">
                                    ...
                                    href="https://twitter.com/intent/tweet?text=Comparing+Black+and+White+Films&amp;url=https%3A%2F%2Fdemo.tagdiv.com%2Fnewspaper_photography%2Ftd-post-comparing-black-and-white-films%2F&amp;via=Newspaper+Photography+Demo"
                                    title="Twitter">
                                    <div class="td-social-but-icon">
                                    ...
                                    href="https://pinterest.com/pin/create/button/?url=https://demo.tagdiv.com/newspaper_photography/td-post-comparing-black-and-white-films/&amp;media=https://demo.tagdiv.com/newspaper_photography/wp-content/uploads/2017/04/39.jpg&amp;description=Comparing+Black+and+White+Films"
                                    title="Pinterest">
                                    <div class="td-social-but-icon">
                                    ...
                                    href="https://api.whatsapp.com/send?text=Comparing+Black+and+White+Films%20%0A%0A%20https://demo.tagdiv.com/newspaper_photography/td-post-comparing-black-and-white-films/"
                                    title="WhatsApp">
                                    <div class="td-social-but-icon">
                    ...
                    <footer>
                            ...
                            <div class="td-block-span6 td-post-prev-post">
                                <div class="td-post-next-prev-content">
                                    <span>Previous article</span><a
                                        href="../td-post-50mm-vs-85mm-lenses-and-how-to-choose/index.html">50mm vs 85mm
                                        Lenses And How to Choose</a>
                                </div>
                            </div>
                            ...
                            <div class="td-block-span6 td-post-next-post">
                                <div class="td-post-next-prev-content">
                                    <span>Next article</span><a
                                        href="../td-post-absolute-best-budget-lenses/index.html">Absolute Best Budget
                                        Lenses</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <meta itemprop="datePublished" content="2017-04-03T13:40:02+00:00" />
                        <meta itemprop="dateModified" content="2017-05-23T11:26:52+00:00" />
                        ...
                        <meta itemprop="headline " content="Comparing Black and White Films" /><span
                            class="td-page-meta" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                            <meta itemprop="url" content="../wp-content/uploads/2017/04/39.jpg" />
                    ...
                    <div class="td_block_wrap td_block_related_posts td-related-full-width tdi_10 td_with_ajax_pagination td-pb-border-top td_block_template_2"
                      ...
                      $retartical = mysqli_query($con, "SELECT * FROM articles WHERE STATUS=1 AND popular=1 ORDER BY entry_date DESC LIMIT 5");
